...
// gets a courteous notice instead of silence.
...
// notifyUnsupported tells a p2p sender their non-text message type is not
// handled yet. Best-effort; failures are logged only.
